...
def test_errordata_from_runtime_single_sentence():
    ...
    result = runtime_to_errordatas(errors, sentence_start=0, sentence_end=7)
...
def test_errordata_from_runtime_multiple_sentences():
    ...
    result1 = runtime_to_errordatas(errors, sentence_start=0, sentence_end=7)
    assert len(result1) == 1
    assert result1[0].error_string == "lea"

    # Second sentence: "Mun badjel" (8-18) - note: no error in this range
    result2 = runtime_to_errordatas(errors, sentence_start=8, sentence_end=18)
    assert len(result2) == 0

    # Third sentence with error: (14-26)
    result3 = runtime_to_errordatas(errors, sentence_start=14, sentence_end=26)
...
def test_errordata_from_runtime_adjusted_positions():
    ...
    result = runtime_to_errordatas(errors, sentence_start=5, sentence_end=20)
